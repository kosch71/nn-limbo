...
class ConvNet:
    ...
    def compute_loss_and_gradients(self, X, y):
        ...
        #делаем forward проход по всем слоям
        ...
        #считаем loss и получаем градиент (dprediction)
        loss, grad = softmax_with_cross_entropy(preds, y)

        #делаем backward проход по всем слоям и считаем градиент
    ...
    def predict(self, X):
        ...
        probs = softmax(preds)
        #возвращаем prediction с максимальной вероятностью
    ...
    def params(self):
        ...
        return {'Conv1.W': self.Conv1.W, 'Conv1.B': self.Conv1.B, 'Conv2.W': self.Conv2.W, 'Conv2.B': self.Conv2.B, 'FC.W': self.FC.W, 'FC.B': self.FC.B}
